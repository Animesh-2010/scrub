...
function Sticker({ children, rot = -3, c = "bg-live text-ink" }: { children: React.ReactNode; rot?: number; c?: string }) {
  return (
    <span
...
export function BrainrotSite() {
  ...
  return (
    <div className="min-h-screen bg-paper text-ink">
      ...
      {/* nav */}
      <header className="sticky top-0 z-[60] border-b-2 border-ink bg-paper/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 md:px-8">
          <span className="text-[19px] font-bold tracking-[-0.04em]">
            SCRUB<span className="text-live">.</span>{" "}
            <span className="font-mono text-[10px] uppercase tracking-[0.2em] opacity-60">brainrot ed.</span>
          </span>
      ...
      <section className="relative overflow-hidden px-4 py-14 md:px-8 md:py-20">
        <div className="mx-auto max-w-6xl">
          <div className="flex flex-wrap gap-2">
            ...
            <Sticker rot={3} c="bg-azure text-ink">it's giving foam</Sticker>
            <Sticker rot={-2} c="bg-clay text-ink">we sent a robot</Sticker>
          </div>
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-8 md:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-7 flex items-start gap-3">
              ...
              <div>
                <p className="font-mono text-[12px] font-bold uppercase tracking-[0.2em]">example</p>
            ...
            <div className="mt-7 flex flex-wrap gap-2">
              <Sticker rot={-3} c="bg-ink text-live">the shrug ends here</Sticker>
      ...
      {/* tier list */}
      <section id="tier" className="border-y-2 border-ink bg-ink px-4 py-14 text-paper md:px-8 md:py-20">
        <div className="mx-auto max-w-6xl">
          <div className="flex flex-wrap items-end justify-between gap-4">
            ...
            <Sticker rot={3} c="bg-live text-ink">all four. no debate.</Sticker>
          </div>
          ...
          <div className="mt-9 grid gap-5 md:grid-cols-2">
            {TIER.map((p, i) => (
              ...
              >
                {p.img ? (
                  <img src={p.img} alt={p.real} loading="lazy" className="aspect-[16/10] w-full object-cover" />
                ) : (
                ...
                <div className="border-t-2 border-ink p-5">
                  ...
                  <h3 className="mt-3 text-[26px] font-bold leading-tight tracking-[-0.035em]">{p.name}</h3>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {randomMemes.map((m, i) => (
              ...
              >
                <span className="tape" aria-hidden="true" />
                <p className="font-mono text-[10px] font-bold uppercase tracking-[0.2em] opacity-60">{m.tag}</p>
                {i % 3 === 0 && (
                  <img
                ...
                <p className="mt-4 text-[21px] font-medium leading-[1.1] tracking-[-0.03em]">{m.top}</p>
      ...
      <section className="border-y-2 border-ink bg-canvas px-4 py-14 md:px-8 md:py-20">
        <div className="mx-auto max-w-6xl">
          <div className="flex flex-wrap items-end justify-between gap-3">
            ...
            <Sticker rot={-3} c="bg-azure text-ink">nobody's watching (we are)</Sticker>
          </div>
      ...
      <Marquee items={["raw footage", "no renders", "the robot works at night", "it doesn't doomscroll"]} dark />
      ...
      <section className="px-4 pb-14 md:px-8 md:pb-20">
        <div className="mx-auto max-w-3xl">
          <div className="mb-6 flex flex-wrap items-end justify-between gap-3">
            ...
            <Sticker rot={3} c="bg-clay text-ink">not real. but they could be.</Sticker>
          </div>
          <CommentSection />
        </div>
      </section>
            ...
            {SQUAD.map((p, i) => (
              ...
              >
                ...
                <div className="border-t-2 border-ink px-3 py-2.5">
                  ...
                  <p className="font-mono text-[9.5px] uppercase tracking-[0.14em] opacity-60">{p.role}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="px-4 py-16 md:px-8 md:py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="mt-4 text-[11vw] font-bold leading-[0.88] tracking-[-0.05em] md:text-[5rem]">
            doomscroll, but you <span className="font-serif italic text-live">learn something</span>
          </h2>
          <p className="mx-auto mt-5 max-w-[44ch] text-[16px] leading-relaxed opacity-75">
            {BANK.length}+ meme cards, shuffled fresh every single time you open it. tap any card for
            the real water fact hiding behind the joke.
          </p>
