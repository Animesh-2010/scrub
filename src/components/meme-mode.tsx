...
const BANK: Meme[] = [
  {
    tag: "POV",
    top: "you tossed one chips packet",
    bottom: "the lake: 'noted. logged. GPS tagged.'",
    fact: "One wrapper takes ~80 years to break down in still water.",
  },
  {
    tag: "NOBODY:",
    top: "absolutely nobody:",
    bottom: "the lake at 4am: *bubbling ominously*",
    fact: "Night-time DO crashes are when fish kills happen.",
  },
  {
    tag: "IT'S GIVING",
    top: "solar powered, zero diesel",
    bottom: "it's giving main character energy",
    fact: "SCRUB runs a full shift on sun alone.",
  },
  {
    tag: "REAL ONES KNOW",
    top: "your city has ~1,200 water bodies",
    bottom: "you can name… two? be so fr",
    fact: "Bengaluru has lost over 1,000 lakes since 1960.",
  },
  {
    tag: "AVERAGE FAN",
    top: "average 'someone will fix it' enjoyer",
    bottom: "vs average lake-adopting chad",
    fact: "Community-adopted lakes recover 3x faster.",
  },
  {
    tag: "GALAXY BRAIN",
    top: "small brain: complain online",
    bottom: "galaxy brain: send a robot",
    fact: "One SCRUB unit replaces a 6-person manual crew.",
  },
  {
    tag: "SIDE EYE",
    top: "'we'll clean it before the election'",
    bottom: "the lake, four elections later: 👁️👄👁️",
  },
  {
    tag: "CORE MEMORY",
    top: "grandpa: 'we used to swim here'",
    bottom: "the here in question: foam mountain",
    fact: "Detergent phosphates cause that meter-high froth.",
  },
  {
    tag: "RATIO",
    top: "your weekend screen time",
    bottom: "hours spent outside near water: 0.0",
    fact: "Blue space exposure measurably drops cortisol.",
  },
  {
    tag: "TUTORIAL",
    top: "how to look rich: designer fit",
    bottom: "how to BE rich: clean tap water",
  },
  {
    tag: "NO THOUGHTS",
    top: "no thoughts, head empty",
    bottom: "just turbidity readings dropping 📉",
    fact: "Turbidity is the fastest signal that cleanup is working.",
  },
  {
    tag: "DELULU",
    top: "'the river cleans itself'",
    bottom: "delulu is not the solulu bestie",
    fact: "Urban lakes have no natural flushing left.",
  },
  {
    tag: "GYATT",
    top: "the amount of sewage inflow is",
    bottom: "genuinely crazy work, chat",
    fact: "~60% of India's urban sewage goes untreated.",
  },
  {
    tag: "MOOD",
    top: "me pretending microplastics",
    bottom: "aren't already in my bloodstream",
    fact: "Average human: ~a credit card of plastic a week.",
  },
  { tag: "SPEEDRUN", top: "killing a lake speedrun", bottom: "any% — current WR: 18 months" },
  {
    tag: "CHARACTER ARC",
    top: "started: throwing bottles in",
    bottom: "now: reading dissolved-oxygen charts",
  },
  {
    tag: "RENT FREE",
    top: "the smell from the main road",
    bottom: "living in your nose rent free",
    fact: "That's ammonia — we log it hourly.",
  },
  { tag: "TOUCH GRASS", top: "touch grass", bottom: "…but make the grass not toxic first" },
  {
    tag: "BOOMER SAYS",
    top: "'kids these days do nothing'",
    bottom: "kids these days: built a robot",
    fact: "SCRUB's core team is undergrads.",
  },
  {
    tag: "SUS",
    top: "the water is a suspicious colour",
    bottom: "amogus lake reveal 📛",
    fact: "Green = algal bloom. Black = anaerobic. Both bad.",
  },
  { tag: "AURA", top: "-1000 aura for littering", bottom: "+5000 aura for a cleanup shift" },
  {
    tag: "MAIN QUEST",
    top: "you've been doing side quests",
    bottom: "the main quest is right here",
  },
  { tag: "CEO OF", top: "CEO of pretending it's fine", bottom: "resign immediately" },
  {
    tag: "PLOT TWIST",
    top: "the villain was never the lake",
    bottom: "it was the pipe upstream",
    fact: "Point-source inflows cause most of the load.",
  },
  {
    tag: "LORE DROP",
    top: "Bengaluru lore: 1,452 lakes",
    bottom: "remaining: fewer than 200",
    fact: "And most of those are Class D or worse.",
  },
  {
    tag: "CANON EVENT",
    top: "every Indian city's canon event:",
    bottom: "a lake that catches fire 🔥",
    fact: "Bellandur foamed AND burned. Repeatedly.",
  },
  {
    tag: "BRAIN ROT",
    top: "you scrolled 47 minutes today",
    bottom: "this took 90 seconds. respect.",
    fact: "You're now more informed than 99% of your feed.",
  },
  ...
  {
    tag: "OK BUT",
    top: "ok but why is the robot",
    bottom: "more responsible than the ward office",
  },
  ...
  {
    tag: "NPC",
    top: "NPC dialogue: 'government should do it'",
    bottom: "unlock new dialogue tree ↓",
  },
  ...
  {
    tag: "SKIBIDI",
    top: "skibidi levels of nonsense:",
    bottom: "dumping sewage into a drinking source",
  },
  {
    tag: "CAUGHT IN 4K",
    top: "the outfall pipe, caught in 4K",
    bottom: "GPS tagged. timestamped. logged.",
  },
  { tag: "LOWKEY", top: "lowkey the coolest job title:", bottom: "'autonomous lake janitor'" },
  {
    tag: "HIGHKEY",
    top: "highkey though —",
    bottom: "this is a ₹6,000 cr market",
    fact: "India's water-remediation TAM keeps growing.",
  },
  ...
  {
    tag: "THIS YOU?",
    top: "'I care about the environment'",
    bottom: "this you? *points at the lake*",
  },
  {
    tag: "ERM",
    top: "erm, what the sludge?",
    bottom: "that's 2m of accumulated silt",
    fact: "Desilting is 60% of restoration cost.",
  },
  ...
  {
    tag: "OBJECTIVELY",
    top: "objectively, the vibes are off",
    bottom: "subjectively, so is the pH",
    fact: "Healthy freshwater sits around pH 6.5–8.5.",
  },
  {
    tag: "IYKYK",
    top: "the smell after first rain",
    bottom: "iykyk 💀",
    fact: "First-flush runoff carries the year's worst load.",
  },
  {
    tag: "GENIUS",
    top: "genius idea: pay people to care",
    bottom: "cheaper idea: show them the data",
  },
  {
    tag: "SORRY WHAT",
    top: "sorry, 69,485 water bodies?",
    bottom: "yeah. India. that's the number.",
  },
